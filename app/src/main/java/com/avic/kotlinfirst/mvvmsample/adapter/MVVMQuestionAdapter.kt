package com.avic.kotlinfirst.mvvmsample.adapter
...
class MVVMQuestionAdapter(private val questList: List<MVVMResultData>, val context: Context): RecyclerView.Adapter<MVVMQuestionAdapter.MyViewHolder>(){


    companion object{
        val log = Logger.getLogger(MVVMQuestionAdapter::class.java.name)
    }
