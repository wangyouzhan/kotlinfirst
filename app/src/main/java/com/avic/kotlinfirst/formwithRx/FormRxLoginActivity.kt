package com.avic.kotlinfirst.formwithRx
...
import kotlinx.android.synthetic.main.activity_form_rx_login.*

class FormRxLoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_form_rx_login)
    }
